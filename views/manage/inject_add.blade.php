...
<form method="post" class="J_ajaxForm" action="{{ route('manageHookInjectAddSave', ['name'=>$hook_name]) }}">
    {{ hst_csrf() }}
        <div class="hstui-pop-cont hstui-pop-table">
            <div class="hstui-form hstui-form-horizontal">
                ...
                <div class="hstui-form-group" id="J_form_error_alias">
                    ...
                    <input type="text" name="alias" id="hstcms_alias" class="hstui-form-field hstui-length-4" value="{{ hst_value('alias') }}" placeholder="">
                </div>
                <div class="hstui-form-group" id="J_form_error_files">
                    ...
                    <input type="text" name="files" id="hstcms_files" class="hstui-form-field hstui-length-4" value="{{ hst_value('files') }}" placeholder="">
                </div>
                <div class="hstui-form-group" id="J_form_error_class">
                    ...
                    <input type="text" name="class" id="hstcms_class" class="hstui-form-field hstui-length-4" value="{{ hst_value('class') }}" placeholder="">
                </div>
                <div class="hstui-form-group" id="J_form_error_fun">
                    ...
                    <input type="text" name="fun" id="hstcms_fun" class="hstui-form-field hstui-length-4" value="{{ hst_value('fun') }}" placeholder="">
                </div>
