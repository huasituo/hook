...
<form method="post" class="J_ajaxForm" action="{{ route('manageHookEditSave') }}">
        ...
        <div class="hstui-pop-cont hstui-pop-table">
            <div class="hstui-form hstui-form-horizontal">
                <div class="hstui-form-group" id="J_form_error_name">
                    ...
                    <input type="text" class="hstui-form-field hstui-length-4" value="{{ hst_value('name', $info) }}" readonly placeholder="">
                </div>
                ...
                <div class="hstui-form-group" id="J_form_error_document">
                    ...
                    <textarea name="document" id="hstcms_document" class="hstui-length-4" placeholder="" style="height: 120px">{{ hst_value('document', $info) }}</textarea>
                </div>
            </div>
        </div>
